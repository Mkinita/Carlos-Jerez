...
const correo = () => {
    ...
    const [formData, setFormData] = useState({
      ...
      const handleSubmit = async (e) => {
        ...
        const transporter = nodemailer.createTransport({
          service: 'Gmail',
          auth: {
            user: 'tu@gmail.com', // Cambia esto por tu dirección de correo electrónico de Gmail
            pass: 'tu_contraseña', // Cambia esto por tu contraseña de Gmail
          },
        });
  ...
  return (
    ...
    <>
        <Layout pagina={'Mensaje'}>
            <Header/>
            <section id="contact" class="relative w-full min-h-screen bg-gray-800 text-white">
...
<div class="relative p-5 lg:px-20 flex flex-col md:flex-row items-center justify-center">
    ...
    <div class="bg-gray-900 border border-white w-full lg:w-1/2 h-full p-5 pt-8">
    ...
    <form action="#" class="w-full md:w-1/2 border border-white p-6 bg-gray-900">
    ...
    <div>
        ...
        <input 
            type="text" id="name" 
            class="px-3 py-2 bg-gray-800 border border-gray-900 focus:border-white focus:outline-none focus:bg-gray-800 focus:text-white"
            autocomplete="off"
        />
    ...
    <div class="w-full pt-3">
        <button type="submit" class="w-full bg-gray-900 border border-white px-4 py-2 transition duration-50 focus:outline-none font-semibold hover:bg-white hover:text-black text-xl cursor-pointer">
        Enviar
        </button>
    </div>
    </form>
