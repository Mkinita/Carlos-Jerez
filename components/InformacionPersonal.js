                ...
                <div className="flex-1 bg-white rounded-lg shadow-xl p-8">
                    ...
                    <ul className="mt-2 text-gray-700">
                        <li className="flex border-y py-2">
                            ...
                            <span className="text-gray-700">Carlos Jerez Flores</span>
                        </li>
                        <li className="flex border-b py-2">
                            <span className="font-bold w-32">Nacimiento:</span>
                            <span className="text-gray-700">23 Septiembre, 1996</span>
                        </li>
                        <li className="flex border-b py-2">
                            <span className="font-bold w-32">Celular:</span>
                            <span className="text-gray-700">(+569) ********</span>
                        </li>
                        <li className="flex border-b py-2">
                            <span className="font-bold w-32">Correo:</span>
                            <span className="text-gray-700">jerez4959@gmail.com</span>
                        </li>
                        <li className="flex border-b py-2">
                            <span className="font-bold w-32">Recidencia:</span>
                            <span className="text-gray-700">Lautaro, Chile</span>
                        </li>
                        <li className="flex items-center border-b py-2 space-x-2">
                            <span className="font-bold w-32">Redes Sociales:</span>
